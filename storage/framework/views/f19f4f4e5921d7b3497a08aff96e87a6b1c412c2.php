...
<?php $component->withAttributes([]); ?>
    ...
    <section class="form-ppdb-container">
        ...
        <form method="POST" action="<?php echo e(route('admin.data-ppdb.update', $formulir->no_form)); ?>"
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-field full-width">
                        ...
                        <input type="text" id="alamat" name="alamat"
                            value="<?php echo e(old('alamat', $formulir->alamat)); ?>" required>
                ...
                <div class="form-group-grid">
                    <div class="form-field">
                        ...
                        <input type="text" id="namaortu" name="namaortu"
                            value="<?php echo e(old('namaortu', $formulir->namaortu)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-field">
                        ...
                        <input type="tel" id="notelportu" name="notelportu"
                            value="<?php echo e(old('notelportu', $formulir->notelportu)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <?php if(auth()->guard()->check()): ?>
                <?php if(Auth::user()->isAdmin()): ?>
                    <fieldset class="form-section">
                        <legend>4. Status Pendaftaran dan Data Siswa Aktif (Hanya Admin)</legend>
                        <div class="form-group-grid two-columns">
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php else: ?>
                    ...
                    <input type="hidden" name="nis_pd" value="<?php echo e($formulir->pesertaDidik->nis ?? ''); ?>">
                    <input type="hidden" name="nisn_pd" value="<?php echo e($formulir->pesertaDidik->nisn ?? ''); ?>">
                    <input type="hidden" name="tahun_masuk_id"
                        value="<?php echo e($formulir->pesertaDidik->tahun_masuk_id ?? $formulir->tahun_masuk_id); ?>">
                <?php endif; ?>
            <?php endif; ?>
            ...
            <div class="form-actions">
                ...
                <a href="<?php echo e(route('admin.data-ppdb')); ?>" class="back-button" style="margin-right: 10px;">Batal</a>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lr_simdik\resources\views/admin/edit-ppdb.blade.php ENDPATH**/ ?>