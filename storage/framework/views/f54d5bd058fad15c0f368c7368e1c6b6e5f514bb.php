...
<head>
    ...
    <style>
        /* CSS Tambahan untuk Header (menirukan <?php echo $__env->make('templates.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> yang responsif) */
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6 mt-6">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <form id="filter-form" action="<?php echo e(route('teacher.data-peserta-didik')); ?>" method="GET"
                            ...
                            <a href="<?php echo e(route('teacher.data-peserta-didik.cetak-pdf', request()->query())); ?>"
                                target="_blank"
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $pesertaDidik; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $siswa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td
                                            ...
                                            <a href="<?php echo e(route('teacher.data-peserta-didik.edit', $siswa->id)); ?>"
...
<?php echo $__env->make('templates.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lr_simdik\resources\views/teacher/data-peserta-didik.blade.php ENDPATH**/ ?>