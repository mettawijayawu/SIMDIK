...
<body
    ...
    background-position: center;';
        ...
        <?php if($activeGelombang && $activeGelombang->tgl_tutup->isFuture()): ?>
            <div class="<?php echo e($heroClass); ?>" <?php echo $heroStyle; ?>>
                <div class="hero-text">
                    SPMB
                    <br>
                    <?php echo e(strtoupper($activeGelombang->nama_gelombang)); ?> DIBUKA!
                </div>
                <p class="countdown-label" id="countdown-display">
                    (Sisa waktu pendaftaran: Menghitung...)
                </p>

                <a href="<?php echo e(url('/formulir')); ?>" class="cta-button" id="cta-button">Daftar Sekarang</a>
    ...
    <?php if($activeGelombang && $activeGelombang->tgl_tutup->isFuture()): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const countDownDate = new Date("<?php echo e($activeGelombang->tgl_tutup->toDateTimeString()); ?>").getTime();
...
<?php /**PATH C:\xampp\htdocs\lr_simdik\resources\views/welcome.blade.php ENDPATH**/ ?>