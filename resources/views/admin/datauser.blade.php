            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        {{-- Tambahkan tombol "Tambah Pengguna" di sini jika ada rute 'create' --}}
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                @if ($user->status == 'admin') bg-red-100 text-red-800 
                                                @elseif($user->status == 'guru') bg-yellow-100 text-yellow-800 
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('admin.data-user.edit', $user) }}"
                                                class="text-indigo-600 hover:text-indigo-900 mr-4">
                                                Edit
                                            </a>

                                            {{-- Tombol Hapus --}}
                                            <form action="{{ route('admin.data-user.destroy', $user) }}" method="POST"
                                                class="inline"
